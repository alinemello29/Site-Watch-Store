  ...
  return (
    <>
      <div className="min-h-[550px] sm:min-h-[700px] bg-gray-100 flex justify-center items-center dark:bg-gray-950 dark:text-white duration-200 relative">
        <div className="h-[700px] w-[700px] bg-teal-300 absolute -top-1/2 right-0 rounded-3xl rotate-45 -z-9"></div>
            ...
            >
              ...
              >
                <button
                  ...
                  className="bg-teal-300 hover:scale-105 duration-200 text-white py-2 px-4 rounded"
                >
                  Order Now
                </button>
              </div>
